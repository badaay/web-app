...
export async function initAddCustomerView() {
    ...
    setTimeout(() => {
        ...
        pickMap.on('click', (e) => {
            ...
            document.getElementById('adv-cust-lat').value = lat;
            document.getElementById('adv-cust-lng').value = lng;
    ...
    document.getElementById('save-adv-customer-btn').onclick = async () => {
        const formData = {
            name: document.getElementById('adv-cust-name').value,
            customer_code: document.getElementById('adv-cust-code').value,
            ktp: document.getElementById('adv-cust-ktp').value,
            phone: document.getElementById('adv-cust-phone').value,
            packet: document.getElementById('adv-cust-packet').value,
            install_date: document.getElementById('adv-cust-install-date').value,
            address: document.getElementById('adv-cust-address').value,
            username: document.getElementById('adv-cust-username').value,
            mac_address: document.getElementById('adv-cust-mac').value,
            lat: parseFloat(document.getElementById('adv-cust-lat').value) || null,
            lng: parseFloat(document.getElementById('adv-cust-lng').value) || null
        };
        ...
        if (!formData.lat || !formData.lng) return alert('Silakan pilih lokasi di peta terlebih dahulu.');
