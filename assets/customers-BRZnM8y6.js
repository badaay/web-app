import{s as T,A as N}from"./config-CON8XM2G.js";import{g as _,a as A}from"./registration-service-BgbwRURY.js";import{g as H,s as q,a as E,p as C}from"./ui-common-hIOATXsD.js";import{s as v}from"./toast-D3E5iWRc.js";import"./config-Dipwna8v.js";async function G(){const y=document.getElementById("customers-list"),B=document.getElementById("add-customer-view-btn");let k=[];B&&(B.onclick=()=>{document.dispatchEvent(new CustomEvent("navigate",{detail:"add-customer-view-content"}))});async function I(){y.innerHTML=H("Memuat pelanggan...");const{data:t,error:c}=await T.from("customers").select("*, roles(name)").order("created_at",{ascending:!1});if(c){y.innerHTML=`<div class="text-danger">Kesalahan: ${c.message}</div>`;return}if(k=t,t.length===0){y.innerHTML=`
