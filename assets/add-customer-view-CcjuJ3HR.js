import{s as d}from"./supabase-DlQAt1xf.js";async function r(){const c=document.getElementById("add-customer-view-container"),n=document.getElementById("back-to-customers-btn");n.onclick=()=>{new bootstrap.Tab(document.getElementById("customers-tab")).show()},c.innerHTML=`
